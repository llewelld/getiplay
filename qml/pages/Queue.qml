...
//            }
            ...
            onClicked: {
                ...
                pageStack.push(Qt.resolvedUrl("QueueItemInfo.qml"), { name: name, progId: progId, qstatus: qstatus, duration: duration, type: type, channel: channel, description: description, episode: episode, timeadded: timeadded, web: web })
            }
